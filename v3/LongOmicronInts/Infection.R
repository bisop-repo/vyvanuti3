...
m1_cox <- coxph(Surv(T1, T2, Infected) ~ InfPrior + VaccStatus + AgeGr + Sex,  data = data)
...
legend("bottomleft", legend = c("Early variants", "Alpha", "Delta", "Omicron", "Full vaccination", "Booster", "Partial vaccination"), col = c("red", "green", "blue", "yellow", "darkred", "darkgreen", "brown"), 
